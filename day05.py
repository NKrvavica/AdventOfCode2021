...
def connect(data, part=1):
    ...
    for points in data:
        ...
        if (x1 == x2) or (y1 == y2) or (part == 2):
            ...
            field[ys, xs] += 1
    return field, (field >= 2).sum()


data = read_input(5)

field1, p1 = connect(data, part=1)
print(p1)

field2, p2 = connect(data, part=2)
print(p2)

# plot the results
import matplotlib.pyplot as plt
field2[field2==0] = np.nan
plt.imshow(field2, cmap='hot', interpolation='nearest')
